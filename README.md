<p align="center">
  <img src="https://raw.githubusercontent.com/Funora-Develop/.github/main/assets/funora-conformance.svg" width="76" height="76" alt="">
</p>

<h1 align="center">Funora Conformance</h1>

<p align="center"><em>Тестовый контракт между языками.</em></p>
...
Языконезависимые тестовые векторы. SDK вправе называть себя совместимым с версией спецификации, только если проходит её обязательный набор. Векторы сравнивают нормализованный JSON — поля, идентификаторы перечислений, коды ошибок, порядок событий, решения о повторе — но никогда внутренние классы языка.
